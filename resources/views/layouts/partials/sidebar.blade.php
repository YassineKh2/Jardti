                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarDashboards">
                        <ul class="nav-second-level">
                            <li>
                                <a href="#" class="tp-link">Analytical</a>
                            </li>
                            <li>
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarAuth">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a class="tp-link" href="#">Recover Password</a>
                            </li>
                            <li>
                                <a class="tp-link" href="#">Lock Screen</a>
                            </li>
                            <li>
                                <a class="tp-link" href="#">Confirm Mail</a>
                            </li>
                            <li>
                                <a class="tp-link" href="#">Email Verification</a>
                            </li>
                            <li>
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarExpages">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a class="tp-link" href="#">Maintenance</a>
                            </li>
                            <li>
                                <a class="tp-link" href="#">Coming Soon</a>
                            </li>
                        </ul>
                    </div>
                </li>
            ...
            <li>
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarBaseui">
                        <ul class="nav-second-level">
                            <li>
                                <a class="tp-link" href="#">Accordions</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="tp-link" href="#">Breadcrumb</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="tp-link" href="#">Dropdowns</a>
                            </li>
                            <li>
                                <a class="tp-link" href="#">Embed Video</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="tp-link" href="#">List Group</a>
                            </li>
                            <li>
                                <a class="tp-link" href="#">Modals</a>
                            </li>
                            <li>
                                <a class="tp-link" href="#">Placeholders</a>
                            </li>
                            <li>
                                <a class="tp-link" href="#">Pagination</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="tp-link" href="#">Scrollspy</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="tp-link" href="#">Typography</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarAdvancedUI">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a class="tp-link" href="#">Notifications</a>
                            </li>
                            <li>
                                <a class="tp-link" href="#">Offcanvas</a>
                            </li>
                            <li>
                                <a class="tp-link" href="#">Range Slider</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarIcons">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a class="tp-link" href="#">Material Design Icons</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarForms">
                        <ul class="nav-second-level">
                            <li>
                                <a class="tp-link" href="#">General Elements</a>
                            </li>
                            <li>
                                <a class="tp-link" href="#">Validation</a>
                            </li>
                            <li>
                                <a class="tp-link" href="#">Quilljs Editor</a>
                            </li>
                            <li>
                                <a class="tp-link" href="#">Picker</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarTables">
                        <ul class="nav-second-level">
                            <li>
                                <a class="tp-link" href="#">Basic Tables</a>
                            </li>
                            <li>
                                <a class="tp-link" href="#">Data Tables</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarMaps">
                        <ul class="nav-second-level">
                            <li>
                                <a class="tp-link" href="#" class="tp-link">Google Maps</a>
                            </li>
                            <li>
                                <a class="tp-link" href="#" class="tp-link">Vector Maps</a>
                            </li>
                        </ul>
                    </div>
                </li>
