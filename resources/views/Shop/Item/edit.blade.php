    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('items.update',$item['id'])}}"  enctype="multipart/form-data" method="POST" id="itemform">
                        {{ csrf_field() }}
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group has-validation">
                                        <input type="text" value="{{$item->name}}" name="name" id="name" class="form-control  @error('name') is-invalid @enderror" id="validationServerUsername" aria-describedby="inputGroupPrepend3 validationServerUsernameFeedback">
                                        @error('name')
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group has-validation">
                                        <input value="{{$item->quantity}}" type="number" name="quantity" id="quantity" class="form-control  @error('quantity') is-invalid @enderror" id="validationServerQuantity" aria-describedby=" validationServerQuantityFeedback">
                                        @error('quantity')
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group has-validation">
                                        <input value="{{$item->price}}" type="number" name="price" id="price" class="form-control  @error('price') is-invalid @enderror" id="validationServerPrice" aria-describedby=" validationServerPriceFeedback">
                                        @error('price')
                                        <div id="validationServerQuantityFeedback" class="invalid-feedback">
                                            {{$message}}
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="description" aria-describedby="validationServerDescriptionFeedback" name="description" rows="5"
                                              spellcheck="false">{{$item->description}}</textarea>
                                    </div>
                                    @error('description')
